...
public class ApplicationSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return username -> coordinationService
                .getOneEmployeeBySsn(username)
                .orElseThrow(() -> new UsernameNotFoundException(apiMessages.getMessage("error.not.found.employee")));
    }
